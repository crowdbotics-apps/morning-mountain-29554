...
## Project Structure
    ...
    ├── morning_mountain_29554  # Django project configurations
...
1. Clone this repo and `cd morning_mountain_29554`
...
2. Clone this repo and `cd morning_mountain_29554`
